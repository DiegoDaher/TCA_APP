...
const ModalAgregarPeriodicos = ({ isOpen, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${apiHost}/api/periodicos/add`, {
        method: 'POST',
        headers: {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    Título del Periodico<span className="text-red-500">*</span>
                    </Label>
                    <textarea
                    id="Titulo"
                    name="Titulo"
              ...
              <div className="space-y-2">
                <Label htmlFor="Año">
                  Año de publicacion <span className="text-red-500">*</span>
                </Label>
                <Input
                  id="Año"
                  name="Año"
                  ...
                  placeholder="Ingrese el/los Año(s) de publicacion"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                    ...
                    value={formData.Observaciones}
                        className="placeholder:text-[var(--selected)] flex h-20 w-full rounded-md border border-input px-3 py-2 text-sm ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                    onChange={handleInputChange}
                    placeholder="Ingrese Observaciones del periodico"
                    required
                    />
                </div>
              </div>
...
export default ModalAgregarPeriodicos;
