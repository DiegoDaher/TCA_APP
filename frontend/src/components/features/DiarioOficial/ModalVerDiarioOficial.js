...
const ModalVerDiarioOficial = ({ isOpen, onClose, libroId }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto m-4" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="sticky top-0 bg-white border-b px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-semibold">Ver Diario Oficial</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-6 py-6">
          {isLoading ? (
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-gray-900">{libroData.Periodo || '***'}</p>
                </div>
            ...
            <div className="text-center text-gray-500 py-12">No se encontró información del registro</div>
          )}
        </div>
      </div>
    </div>
...
export default ModalVerDiarioOficial;
